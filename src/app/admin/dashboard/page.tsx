            ...
            <div className="space-y-6">
                    ...
                    {stats.map((stat) => (
                        <div key={stat.label} className={`glass-card rounded-2xl p-5 ${stat.glow}`}>
                            <div className="flex items-start justify-between mb-4">
                                ...
                                <span className={`flex items-center gap-1 text-xs font-medium px-2 py-1 rounded-full ${stat.positive ? "text-green-400 bg-green-500/10" : "text-red-400 bg-red-500/10"
                                    }`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 glass-card rounded-2xl p-6">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-zinc-500 text-sm">Terça, 24 de Março</p>
                            </div>
                        ...
                        <div className="space-y-3">
                            {todayAppointments.length === 0 ? (
                                ...
                                <div key={i} className="flex items-center gap-4 p-3 rounded-xl hover:bg-white/3 transition-colors group">
                                    ...
                                    <div className="text-right flex-shrink-0">
                                        ...
                                        <span className={`text-xs px-2 py-0.5 rounded-full ${statusConfig[apt.status].color}`}>
                    ...
                    <div className="glass-card rounded-2xl p-6">
                        ...
                        <div className="mt-6 pt-4 border-t border-white/5">
                            <a href="/admin/campaigns" className="text-xs text-brand-400 hover:text-brand-300 transition-colors flex items-center gap-1">
                                Ver campanha ativa <ArrowUpRight className="w-3 h-3" />
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: "Ver Relatórios", href: "/admin/reports", icon: TrendingUp, color: "purple" },
                    ].map((action) => (
                        <a
                            key={action.label}
                            href={action.href}
